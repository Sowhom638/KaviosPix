    ...
    <>
      ...
      <section className="kp-hero text-center">
        <div className="container position-relative" style={{ zIndex: 1 }}>
          <h1>
            Organize Your Visual
            <br />
            <span>Collections Beautifully</span>
          </h1>
          <p className="kp-hero-sub">
            Create, manage, and share albums effortlessly. KaviosPix helps you
            keep your images, screenshots, and reference materials perfectly
            organized.
          </p>
      ...
      <section id="features" className="kp-section">
        <div className="container">
          <div className="kp-section-title">
            ...
            <p>
              Powerful features designed for creators, developers, and teams
            </p>
          </div>
            ...
            {[
              {
                icon: "📁",
                title: "Smart Albums",
                desc: "Organize images into collections with custom tags, filters, and instant search.",
              },
              {
                icon: "🔗",
                title: "Share & Collaborate",
                desc: "Generate shareable links and collaborate with your team in real-time.",
              },
              {
                icon: "️☁️",
                title: "Cloud Sync",
                desc: "Access your albums from any device with automatic cloud synchronization.",
              },
              {
                icon: "🔒",
                title: "Secure & Private",
                desc: "Your data stays yours with end-to-end encryption and granular permissions.",
              },
              {
                icon: "⚡",
                title: "Lightning Fast",
                desc: "Optimized for speed with instant loading and smooth scrolling.",
              },
              {
                icon: "💻",
                title: "Beautiful UI",
                desc: "A clean, modern interface that makes managing your collections enjoyable.",
              },
            ].map((feature, idx) => (
      ...
      <section id="cta" className="kp-cta">
        <div className="container">
          <div className="kp-cta-card">
            ...
            <p>
              Join thousands of users who trust KaviosPix to keep their visual
      ...
      <footer className="kp-footer">
        <div className="container">
          <p style={{ marginBottom: "0.75rem" }}>
            &copy; {new Date().getFullYear()} KaviosPix. All rights reserved.
          </p>
        </div>
      </footer>
    </>
